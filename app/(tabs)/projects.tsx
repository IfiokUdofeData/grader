  ...
  return (
    ...
    <SafeAreaView className="bg-primary h-full relative">
      ...
      <View className="bg-black-200 flex-row justify-between items-center  py-2 pl-4 pr-4">
        ...
        <View className="rounded-lg bg-primary py-2">

          {/* Input Field */}
          <TextInput
            placeholder="Search here..."
            placeholderTextColor="white"
            className="w-60 text-xl px-4 opacity-40"

          />
        </View>

          <View className='border-2 mx-1 rounded-full p-1 border-secondary-300'>
            <Image
              className="h-6 w-6"
              source={images.ifiok}
            />
